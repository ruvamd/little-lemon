    ...
    return (
        <article className="about-us">
            <section className="hero-text">
                ...
                Despite the city's diversity, the two brothers recognized the lack of Mediterranean cuisine in Seattle, 
                and were inspired to bring the flavors of their hometown in Italy to the people of Seattle. The two brothers 
